...
@router.get("/unites-mesure", response_model=list[schemas.UniteMesureResponse])
...
@router.get("/unites-mesure/{id}", response_model=schemas.UniteMesureResponse)
...
@router.post("/unites-mesure", response_model=schemas.UniteMesureResponse, status_code=201)
...
@router.patch("/unites-mesure/{id}", response_model=schemas.UniteMesureResponse)
...
@router.get("/taux-tva", response_model=list[schemas.TauxTvaResponse])
...
@router.get("/taux-tva/{id}", response_model=schemas.TauxTvaResponse)
...
@router.post("/taux-tva", response_model=schemas.TauxTvaResponse, status_code=201)
...
@router.patch("/taux-tva/{id}", response_model=schemas.TauxTvaResponse)
...
@router.get("/familles-produits", response_model=list[schemas.FamilleProduitResponse])
...
@router.get("/familles-produits/{id}", response_model=schemas.FamilleProduitResponse)
...
@router.post("/familles-produits", response_model=schemas.FamilleProduitResponse, status_code=201)
...
@router.patch("/familles-produits/{id}", response_model=schemas.FamilleProduitResponse)
...
@router.delete("/familles-produits/{id}", status_code=204)
...
@router.get("/conditionnements", response_model=list[schemas.ConditionnementResponse])
...
@router.get("/conditionnements/{id}", response_model=schemas.ConditionnementResponse)
...
@router.post("/conditionnements", response_model=schemas.ConditionnementResponse, status_code=201)
...
@router.patch("/conditionnements/{id}", response_model=schemas.ConditionnementResponse)
...
@router.get("/produits", response_model=list[schemas.ProduitResponse])
...
@router.post("/produits", response_model=schemas.ProduitResponse, status_code=201)
...
@router.get("/produits/{produit_id}/conditionnements", response_model=list[schemas.ProduitConditionnementResponse])
...
@router.get("/produits/{produit_id}/prix", response_model=list[schemas.PrixProduitResponse])
...
@router.get("/produits/{produit_id}/variantes", response_model=list[schemas.VarianteProduitResponse])
...
@router.get("/produits/{id}", response_model=schemas.ProduitResponse)
async def get_produit(db: DbSession, current_user: CurrentUser, id: int):
    """Détail d'un produit."""
    return await ProduitService(db).get_or_404(id)


@router.patch("/produits/{id}", response_model=schemas.ProduitResponse)
...
@router.delete("/produits/{id}", status_code=204)
...
@router.get("/produits-conditionnements/{id}", response_model=schemas.ProduitConditionnementResponse)
...
@router.post("/produits-conditionnements", response_model=schemas.ProduitConditionnementResponse, status_code=201)
...
@router.patch("/produits-conditionnements/{id}", response_model=schemas.ProduitConditionnementResponse)
...
@router.delete("/produits-conditionnements/{id}", status_code=204)
...
@router.get("/canaux-vente", response_model=list[schemas.CanalVenteResponse])
...
@router.get("/canaux-vente/{id}", response_model=schemas.CanalVenteResponse)
...
@router.post("/canaux-vente", response_model=schemas.CanalVenteResponse, status_code=201)
...
@router.patch("/canaux-vente/{id}", response_model=schemas.CanalVenteResponse)
...
@router.get("/prix-produits", response_model=list[schemas.PrixProduitResponse])
...
@router.get("/prix-produits/{id}", response_model=schemas.PrixProduitResponse)
...
@router.post("/prix-produits", response_model=schemas.PrixProduitResponse, status_code=201)
...
@router.patch("/prix-produits/{id}", response_model=schemas.PrixProduitResponse)
...
@router.delete("/prix-produits/{id}", status_code=204)
...
@router.get("/variantes-produits/{id}", response_model=schemas.VarianteProduitResponse)
...
@router.post("/variantes-produits", response_model=schemas.VarianteProduitResponse, status_code=201)
...
@router.patch("/variantes-produits/{id}", response_model=schemas.VarianteProduitResponse)
...
@router.delete("/variantes-produits/{id}", status_code=204)

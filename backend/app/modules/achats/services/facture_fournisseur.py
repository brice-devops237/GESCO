...
from app.modules.achats.models import FactureFournisseur, StatutPaiementFournisseur, TypeFactureFournisseur
...
class FactureFournisseurService(BaseAchatsService):
    ...
    async def create(self, data: FactureFournisseurCreate) -> FactureFournisseur:
        ...
        self._validate_enum(data.type_facture, TypeFactureFournisseur, Messages.FACTURE_FOURNISSEUR_TYPE_INVALIDE)
    ...
    async def update(self, id: int, data: FactureFournisseurUpdate) -> FactureFournisseur:
        ...
        if "type_facture" in update_data and update_data["type_facture"] is not None:
            self._validate_enum(
                update_data["type_facture"], TypeFactureFournisseur, Messages.FACTURE_FOURNISSEUR_TYPE_INVALIDE
            )

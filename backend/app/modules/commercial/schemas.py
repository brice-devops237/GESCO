...
# -----------------------------------------------------------------------------
# Schémas Pydantic du module Commercial : validation entrées (Create/Update) et
# sérialisation sorties (Response). Conçus pour toute structure et tout secteur
# (champs optionnels, multi-devise, types facture CGI).
# -----------------------------------------------------------------------------
...
class DevisCreate(BaseModel):
    ...
    client_id: int
    reference_client: str | None = Field(None, max_length=80)
...
class BonLivraisonCreate(BaseModel):
    ...
    numero: str = Field(..., max_length=50)
    date_livraison: date
    contact_livraison: str | None = Field(None, max_length=150)
    adresse_livraison: str | None = None
    etat_id: int
    notes: str | None = None
...
class BonLivraisonResponse(BaseModel):
    ...
    numero: str
    date_livraison: date
    contact_livraison: str | None = None
    etat_id: int
    created_at: datetime

...
class Departement(Base):
    ...
    centre_cout: Mapped[str | None] = mapped_column(String(30), nullable=True)  # Code centre de coût (analytique)
...
class Employe(Base):
    ...
    situation_familiale: Mapped[str | None] = mapped_column(String(20), nullable=True)  # Célibataire, Marié(e), etc.

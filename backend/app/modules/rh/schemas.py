...
# -----------------------------------------------------------------------------
# Schémas Pydantic pour le module RH. Extension monde réel : multi-tenant,
...
class DepartementCreate(BaseModel):
    ...
    centre_cout: str | None = Field(None, max_length=30)
    actif: bool = True
...
class EmployeCreate(BaseModel):
    ...
    situation_familiale: str | None = Field(None, max_length=20)
